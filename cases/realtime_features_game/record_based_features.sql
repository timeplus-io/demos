...
CREATE MATERIALIZED VIEW gamg.mv_total_survival_last_7_game AS
select 
    user_id, 
...
CREATE MATERIALIZED VIEW gamg.mv_total_spend_last_10_transaction AS
select 
    user_id, 
...
CREATE MATERIALIZED VIEW gamg.mv_5_lost_in_a_row AS
select 
    user_id, 

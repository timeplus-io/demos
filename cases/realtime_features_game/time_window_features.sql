...
CREATE MATERIALIZED VIEW gamg.mv_player_features_5m AS
SELECT 
    user_id,
    window_start,
    window_end,
...
CREATE MATERIALIZED VIEW gamg.mv_transaction_features_15m AS
SELECT 
    user_id,
    window_start,
    window_end,
...
CREATE MATERIALIZED VIEW gamg.mv_player_features_1h AS
SELECT 
    user_id,
    window_start,
    window_end,
